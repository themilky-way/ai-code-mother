...
import com.qian.aicodemother.ai.model.message.ToolExecutedMessage;
import com.qian.aicodemother.ai.model.message.ToolRequestMessage;
...
public class AiCodeGeneratorFacade {
     ...
     *
     * @param tokenStream TokenSteam 对象

...
import com.qian.aicodemother.utils.WebScreenshotUtils;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUploadScreenshot(String webUrl) {
        ...
        try {
            ...
            log.info("截图上传成功，对象存储访问 URL：{}", cosUrl);
            return cosUrl;
        } finally {
            // 清理本地文件
    ...
    /**
     * 生成截图的对象存储键
     * 格式：screenshots/2025/11/01/fileName.jpg
     */
